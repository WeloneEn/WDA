...
export const Manifesto = () => {
    ...
    useEffect(() => {
        ...
        const anim = gsap.fromTo(el, { y: 60 }, {
            y: -30, ease: 'none',
        ...
        <section id="manifesto" className="relative z-20" ref={sectionRef}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3">
                ...
                <div className="md:col-span-1 px-6 md:px-10 py-14 md:py-20 border-r border-[#1A1A1A]/15">
                    <span className="text-[10px] uppercase tracking-[0.25em] text-[#1A1A1A]/30 block mb-8">About Studio</span>
                    <div className="relative">
                        <span className="font-editorial text-[4.5em] leading-[0.75] float-left mr-3 mt-1 text-[#1A1A1A] select-none">W</span>
                        <TextReveal as="p" split="lines" className="font-editorial italic text-lg md:text-xl text-[#1A1A1A]/65 leading-[1.7]" start="top 85%">
                            e don't do templates. Every project is a bespoke creation where thoughtful design meets clean code architecture. We build websites and applications that are intuitive for people and effective for business.
                        </TextReveal>
                    </div>
                </div>
