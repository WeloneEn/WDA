...
export const FeaturedShowcase = () => {
    ...
    useEffect(() => {
        ...
        const anims = gsap.fromTo(children, { y: 60, opacity: 0 }, {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3">
                ...
                <div className="showcase-card px-6 md:px-10 py-14 md:py-20 border-r border-[#1A1A1A]/15">
                    ...
                    <p className="font-editorial italic text-lg md:text-xl text-[#1A1A1A]/55 leading-[1.6] mb-8">
                        Fresh works — from design to launch.
                    </p>
                    <p className="font-editorial italic text-base text-[#1A1A1A]/30">
                        <span className="not-italic uppercase text-[10px] tracking-[0.15em] text-[#C24B31]">Hint!</span> Click on the image
                    </p>
                </div>
                ...
                <div className="showcase-card px-6 md:px-10 py-14 md:py-20 border-r border-[#1A1A1A]/15">
                    {featured[0] && (
                        <Link to={`/showcase/${featured[0].slug}`} className="group block">
                            <ParallaxImage src={featured[0].image} alt={featured[0].title} speed={18} className="cinematic-hover w-full aspect-[4/3] mb-5" imgClassName="project-card-image" />
                            <h3 className="text-base uppercase tracking-[0.05em] text-[#1A1A1A] mb-2">{featured[0].title}</h3>
                            <p className="font-editorial italic text-base md:text-lg text-[#1A1A1A]/50 leading-[1.7]">{featured[0].description}</p>
                        </Link>
                    )}
                </div>
                ...
                <div className="showcase-card px-6 md:px-10 py-14 md:py-20 flex flex-col">
                    ...
                    <div className="mt-auto relative">
                        <span className="font-editorial text-[4em] leading-[0.75] float-left mr-3 mt-1 text-[#1A1A1A] select-none border border-[#1A1A1A]/15 px-2">W</span>
                        <p className="font-editorial italic text-base md:text-lg text-[#1A1A1A]/55 leading-[1.7]">
                            e architect digital experiences that speak for themselves. No templates, no compromises. Just pure craftsmanship tailored for ambitious brands.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 border-t border-[#1A1A1A]/15">
                    <div className="md:col-span-2 px-6 md:px-10 py-10 border-r border-[#1A1A1A]/15">
                        <Link to={`/showcase/${featured[1].slug}`} className="group block">
                            <ParallaxImage src={featured[1].image} alt={featured[1].title} speed={12} className="cinematic-hover w-full aspect-[16/9] mb-5" imgClassName="project-card-image" />
                        </Link>
                    </div>
                    <div className="showcase-card px-6 md:px-10 py-10 flex flex-col justify-end">
                        ...
                        <p className="font-editorial italic text-base md:text-lg text-[#1A1A1A]/50 leading-[1.7] mb-4">{featured[1].description}</p>
